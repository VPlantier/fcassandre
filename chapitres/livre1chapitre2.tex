...
\begin{itemize}
\item Puisque tout ce qui est propre à persuader est relatif aux personnes, c'est à dire propre à persuader quelqu'un,
\end{itemize}

De plus,

\begin{itemize}
\item Puisque ces choses-là sont de deux sortes, les unes capables de persuader d'elles-mêmes et croyables d'abord, les
...
\begin{itemize}
\item Puisqu'il n'est point d'art qui s'arrête à considérer la nature d'aucun particulier ni qui en fasse son objet; car
...
\begin{itemize}
\item Que la rhétorique ne se proposera pas non plus, et ne considérera point ce qui est probable à l'égard d'un tel particulier
...
\begin{itemize}
\item  Puisqu'entre les propositions, dont la rhétorique forme ses syllogismes, il s'en trouve peu de nécessaires, car la plupart des matières
...
\begin{itemize}
\item Puisque les propositions contingentes, et qui ne sont vraies que pour l'ordinaire, doivent toujours être prouvées par d'autres de même nature
...
\begin{itemize}
\item Que les matières d'où se tirent les enthymèmes seront pour la plupart incertaines ou contingentes, et qu'il y en aura fort peu de nécessaires.
\end{itemize}
...
\begin{itemize}
\item Un signe que tous les habiles gens sont gens de bien c'est que Socrate, qui était un habite homme, a été très homme de bien.
\end{itemize}
...
\begin{itemize}
\item Un signe que cet homme est malade, c'est qu'il a la fièvre,
\end{itemize}

ou bien:

\begin{itemize}
\item Un signe que cette femme est mère, c'est qu'elle a du lait aux mamelles,
\end{itemize}
...
\begin{itemize}
\item Un signe que cette personne a la fièvre, c'est  qu'elle respire comme si, elle était hors d'haleine.
\end{itemize}
